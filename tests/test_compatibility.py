...
class TestCompatibility(BaseTestCase):
    def test_compatible(self):
        ...
        self.assertTrue(is_compatible(parent_version="0.35.0", child_version="0.35.0"))

    def test_not_compatible(self):
        """Test that compatibility is correctly determined as false for two known incompatible versions."""
        self.assertFalse(is_compatible(parent_version="0.16.0", child_version="0.35.0"))
    ...
    def test_warning_issued_if_no_data_on_parent_version(self):
        ...
        with self.assertLogs() as logging_context:
            self.assertTrue(is_compatible(parent_version="1000000.0.0", child_version="0.26.0"))
    ...
    def test_warning_issued_if_no_data_on_child_version(self):
        ...
        with self.assertLogs() as logging_context:
            self.assertTrue(is_compatible(parent_version="0.26.0", child_version="1000000.0.0"))
