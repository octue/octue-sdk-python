...
class Child:
    ...
    def ask(self, input_values, input_manifest=None, subscribe_to_remote_logs=True, timeout=20):
        ...
        """
        subscription, _ = self._service.ask(self.id, input_values, input_manifest, subscribe_to_remote_logs)
